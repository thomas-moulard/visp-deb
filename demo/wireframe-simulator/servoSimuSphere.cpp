/****************************************************************************
 *
 * $Id: servoSimuSphere.cpp 3625 2012-03-13 19:47:29Z fspindle $
 *
...
main(int argc, const char ** argv)
{
  ...
  vpHomogeneousMatrix temp(vpHomogeneousMatrix(0,0.0,2.5,0,vpMath::rad(140),0)*(sim.get_fMo().inverse()));
